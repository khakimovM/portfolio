...
const ProjectItem: React.FC<Props> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-between p-6 bg-opacity-30 bg-cyan-100 border-blue-400 shadow-lg rounded-lg hover:scale-105 transition-transform">
      ...
      <div className="flex gap-4 items-center text-center mt-4 justify-center w-full">
        {frontLink && (
          <a
            href={frontLink}
            target="_blank"
